        ...
        {activeSandboxTab === 'forecasting' && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '24px' }}>
              ...
              <div style={{ background: 'rgba(5, 8, 20, 0.8)', padding: '20px', borderRadius: '14px', border: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <div style={{ height: '180px', display: 'flex', alignItems: 'flex-end', gap: '8px', justifyContent: 'space-between', paddingTop: '20px' }}>
