...
### 🔐 7. Secure Admin Control Dashboard
* Built-in secure admin portal accessible via the **Admin Portal** button or URL hash (`#admin`).
* Protected by passcode authentication with failed attempt limiter and customizable secret key (default: `karan2026`).
